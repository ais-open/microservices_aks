...
/****** Object:  Database [bookreview-onlinestore-db]    Script Date: 2/9/2019 4:22:50 PM ******/
CREATE DATABASE [bookreview-onlinestore-db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'bookreview-onlinestore-db', FILENAME = N'/var/opt/mssql/data/bookreview-onlinestore-db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'bookreview-onlinestore-db_log', FILENAME = N'/var/opt/mssql/data/bookreview-onlinestore-db_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [bookreview-onlinestore-db] SET COMPATIBILITY_LEVEL = 140
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [bookreview-onlinestore-db].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ARITHABORT OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET  DISABLE_BROKER 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET RECOVERY FULL 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET  MULTI_USER 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [bookreview-onlinestore-db] SET DB_CHAINING OFF 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [bookreview-onlinestore-db] SET QUERY_STORE = OFF
GO

ALTER DATABASE [bookreview-onlinestore-db] SET  READ_WRITE 
GO

USE [bookreview-onlinestore-db]
